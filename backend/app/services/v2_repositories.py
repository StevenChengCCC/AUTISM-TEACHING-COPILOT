...
class V2Repositories:
    ...
    def __init__(self):
        learners = [
            LearnerProfile(id="a102", code="Learner A-102", age=7, avatar="learner-a102", tags=["Visual support", "Short attention span", "Vehicles"], interests=["Vehicles", "Puzzles"], support_needs=["Visual support", "Short attention span"], reinforcement_preferences=["Praise", "Token board"], communication_mode="Short phrases", attention_profile="Benefits from short, structured activities.", notes="Benefits from visual prompts and concise instructions."),
            LearnerProfile(id="b214", code="Learner B-214", age=9, avatar="learner-b214", tags=["AAC", "Communication"], interests=["Music", "Animals"], support_needs=["AAC", "Processing time"], reinforcement_preferences=["Music break", "Praise"], communication_mode="AAC device and gestures", attention_profile="Benefits from predictable pacing and wait time.", notes="Benefits from clear choices and wait time."),
            LearnerProfile(id="c087", code="Learner C-087", age=6, avatar="learner-c087", tags=["Visual support", "Attention"], interests=["Building blocks"], support_needs=["Visual support", "Choice making"], reinforcement_preferences=["Movement break", "Tokens"], communication_mode="Single words and picture exchange", attention_profile="Benefits from movement between short activities.", notes="Needs movement breaks and visual transitions."),
            LearnerProfile(id="n501", code="Learner N-501", age=7, avatar="learner-n501", tags=["Visual prompts", "Short phrases"], interests=["Cars", "Puzzles"], support_needs=["Visual prompts", "Short attention span"], reinforcement_preferences=["Praise", "Tokens"], communication_mode="Short phrases", attention_profile="Hands-on, visual, structured activities.", notes="New learner profile ready for teacher review."),
        ]
        records = [
