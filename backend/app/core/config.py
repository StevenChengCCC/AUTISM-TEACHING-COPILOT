...
class Settings(BaseSettings):
    ...
    ACTIVE_LEARNER_PROFILE_SKILL_VERSION: str = "v2"
    ACTIVE_LESSON_PLANNING_SKILL_VERSION: str = "v2"
    ACTIVE_LESSON_GENERATION_SKILL_VERSION: str = "v2"
    ACTIVE_MATERIAL_GENERATION_SKILL_VERSION: str = "v2"
    ACTIVE_IMAGE_GENERATION_SKILL_VERSION: str = "v2"
    ACTIVE_NY_INSTRUCTIONAL_MATERIALS_SKILL_VERSION: str = "v2"
