...
class MockV2AIProvider(V2AIProvider):
    ...
    def generate_lesson_package(
        ...
        material_titles = {
            ...
            "token_board": "Reinforcement Board",
            "matching_page": "Matching Practice",
            "scenario_cards": "Scenario Cards",
            "sequence_cards": "Sequence Cards",
            "social_narrative": "Social Situation Guide",
            "core_word_board": "Core Word Communication Board",
            "visual_schedule": "Visual Schedule",
            "task_analysis_cards": "Task Analysis Cards",
            "emotion_scale": "Emotion & Regulation Scale",
            "sorting_page": "Sorting Practice",
            "teacher_cue_card": "Teacher Cue Card",
