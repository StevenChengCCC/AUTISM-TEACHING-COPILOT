...
import type {
  ...
  LessonSectionEditPreview, PrintableLessonKitInput,
...
export const lessonKitApi = {
  ...
  previewLessonSectionEdit: (id:string,payload:{sectionId:string;sectionLabel:string;currentText:string;instruction:string;expectedVersion:number}):Promise<LessonSectionEditPreview> => backendClient.post(`/v2/lesson-packages/${id}/section-edit-preview`,payload),
  ...
  generateGeneratedMaterialImage: (id:string):Promise<GeneratedMaterial> => useLocalMock ? lessonKitMockApi.quickEditGeneratedMaterial(id,"regenerate_artwork") : backendClient.post(`/v2/generated-materials/${id}/generate-image`,{}),
  ...
  createPrintableLessonKit: (id:string,payload:PrintableLessonKitInput):Promise<ExportJob> => backendClient.post(`/v2/lesson-packages/${id}/printable-kit`,payload),
  getPrintableLessonKitDownload: (id:string):Promise<HandoffExportDownload> => backendClient.post(`/v2/printable-lesson-kits/${id}/download`),
